      ...
      <div className="bg-gradient-to-b from-teal-50 to-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold mb-6">
            Find Your Dream Job or <br /> <span className="text-teal-600">Perfect Candidate</span>
          </h1>
          <p className="text-xl text-gray-600 mb-10">
            Connect talented applicants with top recruiters. One platform for all your job search and hiring needs.
          </p>
          <div className="flex w-full max-w-2xl mx-auto h-12">
            ...
            />
            <Button onClick={searchJobHandler} className="h-full rounded-r-full bg-teal-600 hover:bg-teal-700 px-8">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Streamlined job applications for candidates and efficient hiring for recruiters
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Applicants can easily apply to jobs with just one click</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <CheckCircle className="h-12 w-12 text-teal-600 mb-4" />
              <h3 className="text-xl font-semibold mb-2">Efficient Hiring</h3>
              <p className="text-gray-600">Recruiters can post jobs and manage applications seamlessly</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <MessageSquare className="h-12 w-12 text-teal-600 mb-4" />
              <h3 className="text-xl font-semibold mb-2">AI Chatbot</h3>
              <p className="text-gray-600">Applicants can get instant answers to their questions</p>
            </div>
          </div>

          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            <div>
              <h2 className="text-3xl font-bold mb-6">Features for Applicants</h2>
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <CheckCircle className="h-6 w-6 text-teal-600 mt-1" />
                  <div>
                    <h3 className="font-semibold mb-1">One-Click Apply</h3>
                    <p className="text-gray-600">Apply to multiple jobs quickly and easily</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Get instant answers to your job-related questions</p>
                  </div>
                </div>
              </div>
            ...
            <div>
              <h2 className="text-3xl font-bold mb-6">Features for Recruiters</h2>
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <Building2 className="h-6 w-6 text-teal-600 mt-1" />
                  <div>
                    <h3 className="font-semibold mb-1">Post Multiple Jobs</h3>
                    <p className="text-gray-600">Easily create and manage job listings</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Efficiently review, approve, or reject applications</p>
                  </div>
                </div>
              </div>
              <Button className="mt-6 bg-teal-600 hover:bg-teal-700">
